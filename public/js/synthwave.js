...
const musicHelper = (function () {
    let wrap = document.querySelector('.index__container');
...
const setupScene = () => {
    ...
    renderer.setSize(deviceInfo.screenWidth() - (padding * 2), deviceInfo.screenHeight() - (padding * 2));
...
LoaderHelper.loadTexture('engineTexture', '../../public/assets/img/gfx/water.jpg');
LoaderHelper.loadTexture('mountainTexture', '../../public/assets/img/gfx/terrain2.jpg'); 